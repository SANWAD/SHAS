<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="Quatation_Grid.aspx.cs" Inherits="Quatation_Grid" Title="Hearing Aid Quotation" %>
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="False"  BorderColor="Black" BorderWidth="0" style="width:100%"> 
       ...
       <div>                    
        ...
        <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto">
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true" CellPadding="3" class="table table-bordered table-striped" style="width:100%" AutoGenerateSelectButton="True" onrowdatabound="GridView1_RowDataBound" onselectedindexchanged="GridView1_SelectedIndexChanged">                    
    </asp:GridView>
        </asp:Panel>  
    </div>
    </div>
