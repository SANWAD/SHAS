...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string s_today = CurDt.ToString("dd/MM/yyyy");
        DateTime Cur_Dt = DateTime.ParseExact(s_today, "dd/MM/yyyy", null);
        DateTime First_Dt = DateTime.ParseExact("01/11/2015", "dd/MM/yyyy", null);
        DateTime Second_Dt = DateTime.ParseExact("31/03/2016", "dd/MM/yyyy", null);
        string Code = "VN";
        if (Cur_Dt >= First_Dt && Cur_Dt <= Second_Dt && Code=="VN")
        {
            cn = new connection();
            txtu_nm.Focus();
            //txtUsrNm.Focus();
