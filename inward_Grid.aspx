<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="inward_Grid.aspx.cs" Inherits="inward_Grid" Title="Inward" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
   ...
   <div class="panel panel-default">
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="False"  BorderColor="Black" BorderWidth="0" style="width:100%"> 
        <table style="width:100%">
        <tr><td colspan="8" align="center"><asp:Label ID="lblMsg" runat="server" Text="Date is Optional & Description i.e Inward To / Inward From " style="font-family:Times New Roman;" Font-Bold="true" ForeColor="red" ></asp:Label></td></tr>
        <tr>
       <td style="width:30%">    
        <div>
