<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="h_mach_sale_Grid.aspx.cs" Inherits="h_mach_sale_Grid" Title="Hearing Aid Sale Invoice" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
  ...
  <div class="panel panel-default">
    ...
    <h class="text-muted text-center" >Hearing Aid Sale Invoice</h>
    </div>
    <div class="panel-body">
    <div class="form-group">
    <table style="width:100%">
    <tr>
    <td><asp:Button ID="btnADD" class="btn btn-primary" runat="server" Text="SALE" onclick="btnADD_Click" />    
            <asp:Button ID="btnPur" runat="server" Text="PURCHASE" class="btn btn-primary" onclick="btnPur_Click"/>    </td>
    <td align="right"><asp:Button ID="btnAdSearch" runat="server" Text="Advance Search" class="btn btn-primary" onclick="btnAdSearch_Click"/> </td>
    </tr>
    </table> 
    </div> 
    <div class="form-group">
