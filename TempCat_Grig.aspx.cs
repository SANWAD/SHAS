...
public partial class TempCat_Grig : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                cmd.CommandText = "MSGTemplate_g";
                cmd.Parameters.Add("@pMSGTEMPID", SqlDbType.Int).Value = ptnt_id;
    ...
    {
        TempCat_Id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/TempCat.aspx?TempCat_Id=" + TempCat_Id);
    }
