...
public partial class MenuMapping_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                cmd.CommandText = "USERMENUMAP_g";
                cmd.Parameters.Add("@pFlag", SqlDbType.Int).Value = Flag;
                cmd.Parameters.Add("@pMAPID", SqlDbType.Int).Value = ptnt_id;
    ...
    {
        Map_Id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/MenuMapping.aspx?Map_Id=" + Map_Id);
    }
