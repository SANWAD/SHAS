<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="Cam_Grid.aspx.cs" Inherits="Cam_Grid" Title="Camp's" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
   ...
   <div class="panel panel-default">
    ...
    <tr>
    <td><asp:Button ID="btnADD" runat="server" Text="ADD" onclick="btnADD_Click" class="btn btn-primary"/></td>
