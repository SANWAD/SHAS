...
public partial class advertising_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                cmd.CommandText = "tbl_advertising_trn_g";
    ...
    {
        int Adv_Id = Convert.ToInt32(GridView1.SelectedValue);
        Response.Redirect("~/advertising.aspx?Adv_Id="+ Adv_Id);
    }
