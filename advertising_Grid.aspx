<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="advertising_Grid.aspx.cs" Inherits="advertising_Grid" Title="Untitled Page" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <tr><td>
        <asp:Button ID="btnADD" runat="server" Text="NEW" onclick="btnADD_Click" class="btn btn-primary"/>
        </td>
        <td align="right">
        <asp:Button ID="btnAdSearch" runat="server" Text="Advance Search" onclick="btnAdSearch_Click" class="btn btn-primary"/>
        </td>
        </tr>
        </table>
