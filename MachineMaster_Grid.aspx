<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="MachineMaster_Grid.aspx.cs" Inherits="MachineMaster_Grid" Title="Hearing Aid Master" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="False"  BorderColor="Black" BorderWidth="0" style="width:100%"> 
        ...
        <tr><td colspan="8" align="center"><asp:Label ID="lblMsg" runat="server" Text="Date is Optional & Description i.e  HAid Code / HAid Company Name /HAid Model Name / HAid Type " style="font-family:Times New Roman;" Font-Bold="true" ForeColor="red" ></asp:Label></td></tr>
        <tr>
       <td style="width:30%">    
        <div>
