<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="Reports_MainPage.aspx.cs" Inherits="Reports" Title="Reports Main Page" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h1 class="text-muted text-center">Reports's</h1>            
        </div>
       ...
       <div> <asp:Button ID="btnSerch" runat="server" Text="Search" class="btn btn-primary" onclick="btnSerch_Click"/></div>
        ...
        <div class="panel-body">
             <div class="col-sm-push-0 col-md-3">             
                    <div class="form-group">             
                    <asp:LinkButton ID="btnAcc" runat="server" Text="Accessories List / Stock" onclick="btnAcc_Click" Font-Bold="True" Font-Size="Large" ForeColor="#666666" Visible="false"></asp:LinkButton>                      
                    </div>
                    <div class="form-group">
                    ...
                    <asp:LinkButton ID="btnFut" runat="server" Text="Future Appointment" 
                     ...
                     <div class="form-group">
                     <asp:LinkButton ID="btnHAid" runat="server" Text="Hearing Aid List / Stock" onclick="btnHAid_Click" Font-Bold="True" Font-Size="Large" ForeColor="#666666" Visible="false"></asp:LinkButton>           
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                    <asp:LinkButton ID="btnPCRpt" runat="server" Text="Petty Cash Report" Font-Bold="True" Font-Size="Large" ForeColor="#666666" onclick="btnPCRpt_Click" Visible="false"></asp:LinkButton>
                    </div> 
                    <div class="form-group">
                     <label>--------------------------------------</label>
                     </div>                    
                    ...
                    <div class="col-sm-push-0 col-md-3">
                    <div class="form-group">
                    <asp:LinkButton ID="btnQuot" runat="server" Text="Quotation" onclick="btnQuot_Click" Font-Bold="True" Font-Size="Large" ForeColor="#666666"></asp:LinkButton>
                    </div>
                    <div class="form-group">
                     <label>--------------------------------------</label>
                     </div>
                    ...
                    <div class="form-group">
                    <asp:LinkButton ID="btnWarr" runat="server" Text="Warranty Card Data" Font-Bold="True" Font-Size="Large" ForeColor="#666666" onclick="btnWarr_Click"></asp:LinkButton>
                    </div> 
                    <div class="form-group">
                     <label>--------------------------------------</label>
                     </div>             
