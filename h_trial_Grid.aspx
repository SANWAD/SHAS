<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="h_trial_Grid.aspx.cs" Inherits="h_trial_Grid" Title="Hearing Aid Trial" %>
       ...
       <div>                    
        ...
        <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" >
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true"  AutoGenerateSelectButton="true" 
                CellPadding="3" class="table table-bordered table-striped" style="widows:100%" 
