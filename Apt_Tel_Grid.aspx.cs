...
public partial class Apt_Tel_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                cmd.CommandText = "tbl_Apt_Tel_trn_g";
                cmd.Parameters.Add("@papt_Tel_id", SqlDbType.Int).Value = ptnt_id;
    ...
    {
        int apt_Tel_id = 0;
        Response.Redirect("Apt_Tel.aspx?apt_Tel_id=" + apt_Tel_id);
    }
    ...
    {
        int apt_Tel_id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/Apt_Tel.aspx?ind_id=" + apt_Tel_id);        
    }
}
