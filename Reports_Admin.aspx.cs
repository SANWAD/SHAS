...
public partial class Admin_Reports : System.Web.UI.Page
{
    ...
    protected void btnPurHAList_Click(object sender, EventArgs e)
    {
        Session["St_Pro_Name"] = "sp_Acc_HA_PurList";
        Session["SEARCH"] = "";
        Session["Doc_Type"] = "PA";
        Session["Type"]="HA";
        Session["FDate"] = txtFr_Dt.Text;
    ...
    protected void btnPurAccList_Click(object sender, EventArgs e)
    {
        Session["St_Pro_Name"] = "sp_Acc_HA_PurList";
        Session["SEARCH"] = "";
        Session["Doc_Type"] = "PA";
