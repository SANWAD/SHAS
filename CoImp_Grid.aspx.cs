...
public partial class CoImp_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    {
        Session["CoCh_Id"] = GridView1.SelectedRow.Cells[1].Text;
        int CoCh_Id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
       // int id = Convert.ToInt32(GridView1.SelectedRow.Cells[17].Text);
        Response.Redirect("~/CochlearImplant.aspx?id=" + CoCh_Id);
    }
    ...
    {
        //int CoCh_Id = 0;
        //Response.Redirect("~/CochlearImplant.aspx?CoCh_Id=" + CoCh_Id);
        Response.Redirect("CochlearImplant.aspx");
    }
