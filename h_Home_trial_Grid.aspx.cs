...
public partial class h_Home_trial_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if(!IsPostBack)
            {
                ...
                cmd.CommandText = "h_m_home_trial_trn_g";
    ...
    {
        int Hom_trial_id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/h_Home_trial.aspx?Hom_trial_id=" + Hom_trial_id);
    }
