...
public partial class Cam_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                cmd.CommandText = "tbl_camp_trn_g";
    ...
    {
        int Camp_Id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/Camps.aspx?Camp_Id=" + Camp_Id);
    }
    protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
    {
        int Camp_Id = Convert.ToInt32(GridView1.SelectedValue);
        Response.Redirect("~/Camps.aspx?Camp_Id="+ Camp_Id);
    }
