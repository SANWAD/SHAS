<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="Appointment_Cancel_Grid.aspx.cs" Inherits="Appointment_Cancel_Grid" Title="Appointment Cancel" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <h class="text-muted text-center" >Appointment Cancel</h>
        </div>
