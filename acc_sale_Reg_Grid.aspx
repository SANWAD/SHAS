<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/SiteMaster.master" CodeFile="acc_sale_Reg_Grid.aspx.cs" Inherits="acc_sale_Reg_Grid"  Title="Accessories Sale"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="form-group">
        ...
        <tr><td colspan="8" align="center"><asp:Label ID="lblMsg" runat="server" Text="Date is Optional & Description i.e  Patient Name / Accessories Description / Center Name" style="font-family:Times New Roman;" Font-Bold="true" ForeColor="red" ></asp:Label></td></tr>
        <tr>   
         <td style="width:30%">
         <div>
        ...
        <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" >
         <asp:GridView ID="GridView1" runat="server" AutoGenerateSelectButton="True" CellPadding="3" class="table table-bordered table-striped"  style="width:100%;" onrowdatabound="GridView1_RowDataBound" onselectedindexchanged="GridView1_SelectedIndexChanged" DataKeyNames="Sale Id" > 
        </asp:GridView>
        </asp:Panel>    
     </div> 
    </div>
