...
public partial class UserMast_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            cmd.CommandText = "tbl_S_as_trn_g";
    ...
    {
        int User_Id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/UserMaster.aspx?User_Id=" + User_Id);
    }
