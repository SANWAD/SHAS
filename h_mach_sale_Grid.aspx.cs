...
public partial class h_mach_sale_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    //SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if(!IsPostBack)
            {
                ...
                cmd.CommandText = "tbl_hm_sale_trn_g";
                ...
                cmd.Parameters.Add("@pCntr_id", Convert.ToInt32(Session["Cntr_id"].ToString()));
                cmd.Connection = con;
                try
                {
                    con.Open();
    ...
    {
        int sale_id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/h_mach_sale_Disc.aspx?sale_id=" + sale_id);
    }
    ...
    protected void btnSerch_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.Add("@pCntr_id", Convert.ToInt32(Session["Cntr_id"]));
        cmd.Connection = con;
        try
        {
            con.Open();
