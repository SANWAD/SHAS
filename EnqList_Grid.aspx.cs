...
public partial class EnqList_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    {
        int Enq_Id = 0;
        Response.Redirect("~/Enquiry.aspx?Enq_Id=" + Enq_Id);
    }
    ...
    {
        int Enq_Id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("Enquiry.aspx?Enq_Id=" + Enq_Id);
    }   
}
