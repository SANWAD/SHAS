<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="UserMast_Grid.aspx.cs" Inherits="UserMast_Grid" Title="User Master" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
    ...
    <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" >
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true" AutoGenerateSelectButton="true" CellPadding="3" class="table table-bordered table-striped"  style="width:100%">    
        </asp:GridView>
        </asp:Panel>
     </div>
</div> 
