<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="h_assessment_Grid.aspx.cs" Inherits="h_assessment_Grid" Title="Hearing Assesment" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
  <ContentTemplate>
    ...
    <h class="text-muted text-center" >Hearing Assessment</h>
    </div>
    <div class="panel-body">
    <div class="form-group">
    <table style="width:100%">
    <tr>
    <td><asp:Button ID="btnADD" runat="server" Text="NEW" onclick="btnADD_Click" class="btn btn-primary" Visible="false"/>    </td>
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="False"  BorderColor="Black" BorderWidth="0" style="Width:100%"> 
        <table style="Width:100%">
        <tr><td colspan="8" align="center"><asp:Label ID="lblMsg" runat="server" Text="Date is Optional & Description i.e Patient Name / Patient Code /Center Name " style="font-family:Times New Roman;" Font-Bold="true" ForeColor="red" ></asp:Label></td></tr>
        <tr>
       <td style="Width:30%">    
        <div>
    ...
    <div class="form-group">
     <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" >
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true" AutoGenerateSelectButton="true" CellPadding="3" class="table table-bordered table-striped"  style="width:100%" onrowdatabound="GridView1_RowDataBound" onselectedindexchanged="GridView1_SelectedIndexChanged">    
        </asp:GridView>
        </asp:Panel>
    </div> 
    </div>
