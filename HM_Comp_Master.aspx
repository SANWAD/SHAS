<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true"
    CodeFile="HM_Comp_Master.aspx.cs" Inherits="HM_Comp_Master" Title="Hearing Aid Company Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <ContentTemplate>
    ...
    <div class="col-sm-push-0 col-md-5"> 
       ...
       <%-- <table style="width:100%">
        ...
        <asp:TextBox ID="txtComp_Code" runat="server" class="form-control" Enabled="False"></asp:TextBox> 
         <%-- </td> 
        <td style="width:1%">
        <asp:RequiredFieldValidator ID="reqComp_Code" ControlToValidate="txtComp_Code" runat="server" ErrorMessage="Required Hearing Aid Company Code" Text="*" EnableClientScript="true" SetFocusOnError="true"></asp:RequiredFieldValidator>
        </td> 
        </tr> 
        </table> --%>        
        </div> 
        ...
        <td style="width:1%">
        <asp:RequiredFieldValidator ID="reqName" ControlToValidate="txtComp_nm" runat="server" ErrorMessage="Required Hearing Aid Company Name" Text="*" EnableClientScript="true" SetFocusOnError="true"></asp:RequiredFieldValidator>
        </td> 
        </tr> 
        </table>            
        </div>
    ...
    <td style="width:1%">
        <asp:RequiredFieldValidator ID="reqAdd" ControlToValidate="txtComp_Add" runat="server"  ErrorMessage="Required Hearing Aid Company Address" Text="*" EnableClientScript="true" SetFocusOnError="true"></asp:RequiredFieldValidator>
    </td> 
    </tr> 
</table> 
    </div>
