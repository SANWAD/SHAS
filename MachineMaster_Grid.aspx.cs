...
public partial class MachineMaster_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(!IsPostBack)
        {
            ...
            cmd.CommandText = "tbl_machine_master_g";
    ...
    {
        int Mach_Id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/MachineMaster.aspx?Mach_Id="+ Mach_Id);
    }
