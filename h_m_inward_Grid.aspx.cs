...
public partial class h_m_inward_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if(!IsPostBack)
            {
                ...
                cmd.CommandText = "tbl_hm_inward_trn_g";
                cmd.Parameters.Add("@p_Hm_inw_id", SqlDbType.Int).Value = ptnt_id;
    ...
    {
        int Inward_Id = 0;
        Response.Redirect("~/h_m_inward.aspx?Inward_Id=" + Inward_Id);
    }
    ...
    {
        int Inward_Id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/h_m_inward.aspx?Inward_Id=" + Inward_Id);
    }
