...
public partial class outward_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                cmd.CommandText = "tbl_ord_nhm_trn_g";
    ...
    {
        int Ord_id = 0;
        Response.Redirect("~/OrderForm.aspx?Out_id=" + Ord_id);
    }
    ...
    {
        int Ord_id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/OrderForm.aspx?Ord_id=" + Ord_id);
    }
}
