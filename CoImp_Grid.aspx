<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="CoImp_Grid.aspx.cs" Inherits="CoImp_Grid" Title="Cochelar Implant" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
    <ContentTemplate>
       <div class="panel panel-default">
        ...
        <h class="text-muted text-center" >Cochelar Implant</h>
        </div>
        <div class="panel-body">
        <div class="form-group">
        <table style="width:100%">
        <tr>
        <td><asp:Button ID="btnADD" runat="server" Text="NEW" onclick="btnADD_Click" 
                class="btn btn-primary" Visible="False"/></td>
