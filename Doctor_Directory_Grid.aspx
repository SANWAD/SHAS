<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="Doctor_Directory_Grid.aspx.cs" Inherits="Master_Doctor_Directory" Title="Doctor Master" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="False"  BorderColor="Black" BorderWidth="0" style="width:100%"> 
        <table style="width:100%">
        <tr><td colspan="8" align="center"><asp:Label ID="lblMsg" runat="server" Text="Date is Optional & Description i.e Doctor's Name / Doctor's Code / Center Name" style="font-family:Times New Roman;" Font-Bold="true" ForeColor="red" ></asp:Label></td></tr>
        <tr>
       <td style="width:30%">    
        <div>
       ...
       <td style="width:2%">
            <div><asp:Image ID="Image" ImageUrl="~/images/calendar.png" runat="server" /></div>                              
        </td>  
       <td style="width:30%">
        <div>
       ...
       <div>                    
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true" AutoGenerateSelectButton="true"  CellPadding="3" style="width:100%" class="table table-bordered table-striped" onselectedindexchanged="GridView1_SelectedIndexChanged" onrowdatabound="GridView1_RowDataBound">                                  
        </asp:GridView>
        </asp:Panel>      
    </div>
    </div>
