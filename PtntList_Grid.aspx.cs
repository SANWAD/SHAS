...
public partial class PtntList_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
//    SqlCommand cmd;
  ...
  //  DataSet ds, ds1;
   ...
   int ptnt_id;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                cmd.CommandText = "tbl_ptn_master_g";
    ...
    {
        int ptnt_id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/PatientRegistration.aspx?ptnt_id=" + ptnt_id);
    }
