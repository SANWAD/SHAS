<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="PtntList_Grid.aspx.cs" Inherits="PtntList_Grid" Title="Patient List" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
    ...
    <h class="text-muted text-center" >New Patient Registration & Registered Patient</h>
    </div>
    <div class="panel-body">
    <div class="form-group">
    <table style="width:100%">        
    <tr>
    <td><asp:Button ID="btnADD" class="btn btn-primary" runat="server" Text="NEW" onclick="btnADD_Click" />    </td>
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="False"  BorderColor="Black" BorderWidth="0" style="width:100%"> 
        <table style="width:100%">
        <tr><td colspan="8" align="center"><asp:Label ID="lblMsg" runat="server" Text="Date is Optional & Description i.e Patient Name / Patient Code / Center Name / Patient Type " style="font-family:Times New Roman;" Font-Bold="true" ForeColor="red" ></asp:Label></td></tr>
        <tr>
       <td style="width:30%">    
        <div>
