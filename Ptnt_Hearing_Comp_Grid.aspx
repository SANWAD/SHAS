<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="Ptnt_Hearing_Comp_Grid.aspx.cs" Inherits="Ptnt_Hearing_Comp_Grid" Title="Patient,Hearing Aid & Company" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
   ...
   <div class="panel panel-default">
    ...
    <h class="text-muted text-center" >Patient,Hearing Aid & Company Search</h>
    </div>
    <div class="panel-body">
    <div class="form-group">
        <table style="width:100%">
        <tr><td><asp:Button ID="btnADD" runat="server" Text="NEW" onclick="btnADD_Click" class="btn btn-primary"/></td>
        <td align="right"><asp:Button ID="btnAdSearch" runat="server" Text="Advance Search" onclick="btnAdSearch_Click" class="btn btn-primary"/>
        </td></tr></table>
        </div> 
    <div class="form-group">
      <asp:Panel ID="Panel1" runat="server" Visible="False" BorderColor="Black" BorderWidth="0">  
        <table style="width:100%">
        <tr><td colspan="8" align="center"><asp:Label ID="lblMsg" runat="server" Text="Date is Optional & Description i.e Patient Name / Hearing Aid Company Name / Searial No" style="font-family:Times New Roman;" Font-Bold="true" ForeColor="red" ></asp:Label></td></tr>
        <tr>   
         <td style="width:20%">
         <div>     
      ...
      <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto"  style="width:100%">
