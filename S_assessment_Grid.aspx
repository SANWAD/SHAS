<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="S_assessment_Grid.aspx.cs" Inherits="S_assessment_Grid" Title="Speech Assesment" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
   ...
   <div class="panel panel-default">
        ...
        <h class="text-muted text-center" >Speech Assessment</h>
        </div>
        <div class="panel-body">
        <div class="form-group">
        <table style="width:100%">
        <tr>
        <td><asp:Button ID="btnADD" runat="server" Text="ADD" onclick="btnADD_Click" class="btn btn-primary" Visible="false"/>    </td>
