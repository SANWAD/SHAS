<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="DueAmount_Grid.aspx.cs" Inherits="DueAmount_Grid" Title="Due Amount Patient List" %>
...
<asp:updatepanel id="UpdatePanel1" runat="server">
    ...
    <h class="text-muted text-center" >Due Amount Patient List</h>
    </div>
