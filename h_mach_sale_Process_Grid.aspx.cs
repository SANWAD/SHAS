...
public partial class h_mach_sale_Process_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                cmd.CommandText = "tbl_hm_sale_Process_trn_g";
    ...
    {
        int sale_Pro_id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/h_mach_sale_Process.aspx?sale_Pro_id=" + sale_Pro_id);
    }
