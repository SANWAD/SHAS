...
public partial class H_Aid_Programming_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    {
        int Prog_Id = 0;
        Response.Redirect("~/H_Aid_Programming.aspx?Prog_Id=" + Prog_Id);
    }
    ...
    {
        int Prog_Id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);
        Response.Redirect("~/H_Aid_Programming.aspx?Prog_Id=" + Prog_Id);
    }
