...
public partial class Comp_HAidTrial_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                cmd.CommandText = "tbl_Comp_Trial_trn_g";
                cmd.Parameters.Add("@pTrial_No", SqlDbType.Int).Value = ptnt_id;
    ...
    {
        int Trial_id = 0;
        Response.Redirect("Comp_HAidTrial.aspx?Trial_id=" + Trial_id);
    }
    ...
    {
        int Trial_id = Convert.ToInt32(GridView1.SelectedRow.Cells[1].Text);         
        Response.Redirect("Comp_HAidTrial.aspx?Trial_id=" + Trial_id);
    }
}
