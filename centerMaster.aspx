<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="centerMaster.aspx.cs" Inherits="centerMaster" Title="Center Master" %>
...
<ContentTemplate>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h class="text-muted text-center">Center Master</h>
        </div>
        <div class="panel-body" >
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="lbl_ac_id1" runat="server" class="form-control" Enabled="false"></asp:TextBox>
                </div>               
                <div class="form-group">
                ...
                <td style="width:99%"> 
                        ...
                        <asp:Label ID="Label2" runat="server" Text="Center Name"></asp:Label>
                    <asp:TextBox ID="txt_ac_desc" runat="server" class="form-control" 
                            ontextchanged="txt_ac_desc_TextChanged" AutoPostBack="true" ></asp:TextBox>
                </td>
                <td style="width:1%">
                    <asp:RequiredFieldValidator runat="server" id="reqName" controltovalidate="txt_ac_desc" ErrorMessage="Required Center Name" Text="*" SetFocusOnError="true" /> 
                </td>
                </tr>
                </table>
                </div>   
