...
public partial class h_assessment_Grid : System.Web.UI.Page
{
    #region Declaration
    connection cn;
    SqlCommand cmd;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                cmd.CommandText = "tbl_h_as_trn_g";
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session["Ass_id"] = GridView1.SelectedRow.Cells[1].Text;
        int id = Convert.ToInt32(GridView1.SelectedRow.Cells[11].Text);
        Response.Redirect("~/h_assessment.aspx?id=" + id + "");
       // Response.Redirect("~/h_assessment.aspx");
    }
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            //if (e.Row.Cells[5].Text != "Patient Code")
            //{
